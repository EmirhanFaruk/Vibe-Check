...
# Modification date: Wed Nov 15 20:35:06 2023

# Production date: Sun Sep  3 15:44:19 2023
...
arkaplana bir de şehir yap belki
belki dönüşümlü ay-güneş
müzik sesleri çok fazla onu ayarla
"""
"""
...
win = pygame.display.set_mode((monitor_size), pygame.FULLSCREEN)#(600, 600), pygame.FULLSCREEN)
...
palms = []
for i in range(6):
    palms.append(Palm(palm_images, 10, (width - 150) + (((width + 150)/6)*(i + 1)), platform_height * 9))
...
music_text = Text(width + 30, height - platform_height, f"Şimdi çalıyor: ", int(platform_height/2), music_names[index], 10)
